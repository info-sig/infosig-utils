...
class FunctionalTest < UnitTest
  ...
  def test_currying_with_functional_class_vs_currying_with_proc
    ...
    assert_equal 8, R.curry(Add2.new.as_proc)[3][5], '[.][.] is off'
